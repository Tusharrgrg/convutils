        ...
        <div className='container'>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item" >
                    <h2 className="accordion-header" style = {borderC}  id="headingOne"> 
                ...
                <div className="accordion-item" style={styles}>
                    <h2 className="accordion-header" style = {borderC}  id="headingTwo">
                ...
                <div className="accordion-item" style={styles}>
                    <h2 className="accordion-header"  style = {borderC} id="headingThree">
